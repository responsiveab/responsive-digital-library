    ...
    <main className='Book-Wrapper'>
        ...
        { 
            <div className='Book-Meta'>
                <span className='Book-Date'><b>Published: </b>{showResults ?  <ContentEditable title="published" onChange={handleChange} onBlur={handleChange} html={bookMod.published} /> : book.published}</span> 
                ...
                <span className='Book-Id'><b>ISBN: </b>{book._id}</span>
