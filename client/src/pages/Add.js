    ...
    const addTag = (t) => {
        ...
        if (t) {
            if (check_tag_exists(t)) {
                ...
                axios
                    .patch(
                        process.env.REACT_APP_API_URL + "/api/tags/" + isbnNr,
                        modifiedFields
                    )
                    .then((res) => {
                        console.log(res);
                ...
                axios
                    .post(process.env.REACT_APP_API_URL + "/api/tags/", newTag)
                    .then((res) => {
                        console.log(res.data.data);
                        let modifiedFields = {
                            tag: res.data.data,
        ...
        <>
            ...
            >
                <input
                    ...
                    name="isbn"
                    placeholder="ISBN"
                    onInput={(e) => setIsbnNr(e.target.value)}
                />
                {isbnNr &&
                    isbnNr.length > 8 &&
                    (book ? (
                        <div className="outline">
                            {book.img !== "Bild saknas" ? (
